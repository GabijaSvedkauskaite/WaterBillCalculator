...
Student Name: Gabija Svedkauskaite
Student ID: 2015573351
Email: sc21gs@leeds.ac.uk
Date Work Commenced: 07/11/2021
...
// YOU WILL ALSO USE THIS SECTION TO INITIALISE ANY VARAIABLES THAT REQUIRE PROPER INITIALISATION
    ...
    double DomesticCustomerCount; // Count how many domestic customers used the program
...
// DOMESTIC CUSTOMER
    ...
    if (CustomerType == 1) {
        ...
        QWasteWaterCharge = 0.95 * QWaterConsumption * 0.25;
        if (QWaterConsumption >= 0 && QWaterConsumption <= 5) {
            ...
            double BandOne = (QWaterConsumption - (QWaterConsumption - 5)) * 0.20;
            QFreshWaterCharge = ((QWaterConsumption - 5) * 0.35) + BandOne; 
        }
        else if (QWaterConsumption > 12 && QWaterConsumption <= 25) {
            double BandOne = (QWaterConsumption - (QWaterConsumption - 5)) * 0.20;
            double BandTwo = ((QWaterConsumption - (QWaterConsumption - (QWaterConsumption - 5) + (QWaterConsumption - 12))) * 0.35) + BandOne;
            QFreshWaterCharge = ((QWaterConsumption - 12) * 0.50) + BandTwo;
        }
        else if (QWaterConsumption > 25 && QWaterConsumption <= 40) {
            double BandOne = (QWaterConsumption - (QWaterConsumption - 5)) * 0.20;
            double BandTwo = ((QWaterConsumption - (QWaterConsumption - (QWaterConsumption - 5) + (QWaterConsumption - 12))) * 0.35) + BandOne;
            double BandThree = (((QWaterConsumption - 12) - (QWaterConsumption - 25)) * 0.50)  + BandTwo;
            QFreshWaterCharge = ((QWaterConsumption - 25) * 0.75) + BandThree;
        }
        else if (QWaterConsumption > 40) {
            double BandOne = (QWaterConsumption - (QWaterConsumption - 5)) * 0.20;
            double BandTwo = ((QWaterConsumption - (QWaterConsumption - (QWaterConsumption - 5) + (QWaterConsumption - 12))) * 0.35) + BandOne;
            double BandThree = (((QWaterConsumption - 12) - (QWaterConsumption - 25)) * 0.50)  + BandTwo;
            double BandFour = (((QWaterConsumption - 25) - (QWaterConsumption - 40)) * 0.75)  + BandThree;
            QFreshWaterCharge = ((QWaterConsumption - 40) * 2.50) + BandFour;
        }
        QTotalCharge = QSurfaceWaterCharge + QStandingCharges + QWasteWaterCharge + QFreshWaterCharge;
    ...
    // COMMERCIAL CUSTOMER
        ...
        QWasteWaterCharge = 0.95 * QWaterConsumption * 2.00;
...
// SUMS AND VALUES
    ...
    DomesticCustomerCount += CustomerType == 1;
    if(CustomerType == 1) {
        QTotalDomestic += QWaterConsumption;
        QAverageDomesticBill = QTotalCharge / DomesticCustomerCount;
    };
